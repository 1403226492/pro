...
public class JavaMailUtils {  
    ...
    public static void main(String[] args) throws Exception {  
       ...
       int res=sendEmail("smtp.qq.com", "1403226492@qq.com", "ddrmmnscnldababj", "1403226492@qq.com", new String[]{  
                "2583687798@qq.com","13323626016@163.com" //这里就是一系列的收件人的邮箱了  
        }, "天气预报",sb.toString(),"text/html;charset=utf-8");  
